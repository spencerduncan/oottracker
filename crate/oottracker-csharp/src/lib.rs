...
#[no_mangle]
pub extern "C" fn expected_bizhawk_version_string() -> StringHandle {
    StringHandle::from_string(include_str!(concat!(
        env!("OUT_DIR"),
        "/bizhawk-version.txt"
    )))
}
...
#[no_mangle]
pub extern "C" fn running_bizhawk_version_string() -> StringHandle {
    #[cfg(windows)]
    {
...
#[no_mangle]
pub extern "C" fn version_string() -> StringHandle {
    StringHandle::from_string(version())
}

#[no_mangle]
pub extern "C" fn update_available() -> HandleOwned<DebugResult<bool>> {
...
#[no_mangle]
pub unsafe extern "C" fn bool_result_free(bool_res: HandleOwned<DebugResult<bool>>) {
...
#[no_mangle]
pub unsafe extern "C" fn bool_result_is_ok(bool_res: *const DebugResult<bool>) -> FfiBool {
    (&*bool_res).is_ok().into()
}
...
/// `bool_res` must point at a valid `DebugResult<bool>`. This function takes ownership of the `DebugResult`.
#[no_mangle]
pub unsafe extern "C" fn bool_result_unwrap(bool_res: HandleOwned<DebugResult<bool>>) -> FfiBool {
...
/// `bool_res` must point at a valid `DebugResult<bool>`. This function takes ownership of the `DebugResult`.
#[no_mangle]
pub unsafe extern "C" fn bool_result_debug_err(
    bool_res: HandleOwned<DebugResult<bool>>,
) -> StringHandle {
    StringHandle::from_string(bool_res.into_box().unwrap_err())
}

#[no_mangle]
pub extern "C" fn run_updater() -> HandleOwned<DebugResult<()>> {
    #[cfg(target_os = "windows")]
    fn inner() -> DebugResult<()> {
        ...
        let updater_data = include_bytes!(
            "../../../target/x86_64-pc-windows-msvc/release/oottracker-updater-bizhawk.exe"
        );
        ...
        Command::new(updater_path)
            .arg(
                env::current_exe()?
                    .canonicalize()?
                    .parent()
                    .ok_or(DebugError(format!("current executable at filesystem root")))?,
            )
...
#[no_mangle]
pub extern "C" fn config_default() -> HandleOwned<Config> {
    HandleOwned::new(Config::default())
}

#[no_mangle]
pub extern "C" fn config_load() -> HandleOwned<DebugResult<Option<Config>>> {
...
#[no_mangle]
pub unsafe extern "C" fn opt_config_result_free(
    opt_cfg_res: HandleOwned<DebugResult<Option<Config>>>,
) {
...
#[no_mangle]
pub unsafe extern "C" fn opt_config_result_is_ok(
    opt_cfg_res: *const DebugResult<Option<Config>>,
) -> FfiBool {
...
/// `opt_cfg_res` must point at a valid `DebugResult<Option<Config>>`.
#[no_mangle]
pub unsafe extern "C" fn opt_config_result_is_ok_some(
    opt_cfg_res: *const DebugResult<Option<Config>>,
) -> FfiBool {
    (&*opt_cfg_res)
        .as_ref()
...
/// `opt_cfg_res` must point at a valid `DebugResult<Option<Config>>`. This function takes ownership of the `DebugResult`.
#[no_mangle]
pub unsafe extern "C" fn opt_config_result_unwrap_unwrap_or_default(
    opt_cfg_res: HandleOwned<DebugResult<Option<Config>>>,
) -> HandleOwned<Config> {
...
/// `opt_cfg_res` must point at a valid `DebugResult<Option<Config>>`. This function takes ownership of the `DebugResult`.
#[no_mangle]
pub unsafe extern "C" fn opt_config_result_debug_err(
    opt_cfg_res: HandleOwned<DebugResult<Option<Config>>>,
) -> StringHandle {
...
#[no_mangle]
pub unsafe extern "C" fn config_free(cfg: HandleOwned<Config>) {
    let _ = cfg.into_box();
}
...
#[no_mangle]
pub unsafe extern "C" fn config_update_check_is_some(cfg: *const Config) -> FfiBool {
...
/// `cfg` must point at a valid `Config`.
#[no_mangle]
pub unsafe extern "C" fn config_update_check(cfg: *const Config) -> FfiBool {
...
#[no_mangle]
pub unsafe extern "C" fn config_set_update_check(
    cfg: *mut Config,
    auto_update_check: FfiBool,
...
/// `cfg` must point at a valid `Config`.
#[no_mangle]
pub unsafe extern "C" fn config_layout(cfg: *const Config) -> HandleOwned<TrackerLayout> {
...
#[no_mangle]
pub unsafe extern "C" fn layout_free(layout: HandleOwned<TrackerLayout>) {
...
#[no_mangle]
pub unsafe extern "C" fn layout_cell(
    layout: *const TrackerLayout,
    idx: u8,
) -> HandleOwned<TrackerCellId> {
...
#[no_mangle]
pub unsafe extern "C" fn cell_free(cell: HandleOwned<TrackerCellId>) {
    let _ = cell.into_box();
}
...
#[no_mangle]
pub unsafe extern "C" fn cell_image(
    model: *const ModelState,
    cell: *const TrackerCellId,
) -> StringHandle {
    let state = &*model;
    let cell = &*cell;
    let CellRender {
    ...
    StringHandle::from_string(
        match (style, overlay) {
            ...
            (CellStyle::Normal, CellOverlay::Count { count, count_img }) => format!(
                "{}_{}",
                count_img.to_string('.', ImageDirContext::Count(count)),
                count
            ),
            (CellStyle::Normal, CellOverlay::Image(overlay)) => {
                img.with_overlay(&overlay).to_string('.', true)
            }
            (CellStyle::Dimmed, CellOverlay::None) => img.to_string('.', ImageDirContext::Dimmed),
            (CellStyle::Dimmed, CellOverlay::Image(overlay)) => {
                img.with_overlay(&overlay).to_string('.', false)
            }
            (_, CellOverlay::Location { loc, style }) => loc.to_string(
                '.',
                match style {
...
#[no_mangle]
pub unsafe extern "C" fn connect_ipv4(addr: *const u8) -> HandleOwned<DebugResult<TcpStream>> {
    assert!(!addr.is_null());
...
#[no_mangle]
pub unsafe extern "C" fn connect_ipv6(addr: *const u8) -> HandleOwned<DebugResult<TcpStream>> {
    assert!(!addr.is_null());
...
#[no_mangle]
pub unsafe extern "C" fn tcp_stream_result_free(
    tcp_stream_res: HandleOwned<DebugResult<TcpStream>>,
) {
...
#[no_mangle]
pub unsafe extern "C" fn tcp_stream_result_is_ok(
    tcp_stream_res: *const DebugResult<TcpStream>,
) -> FfiBool {
...
/// `tcp_stream_res` must point at a valid `DebugResult<TcpStream>`. This function takes ownership of the `DebugResult`.
#[no_mangle]
pub unsafe extern "C" fn tcp_stream_result_unwrap(
    tcp_stream_res: HandleOwned<DebugResult<TcpStream>>,
) -> HandleOwned<TcpStream> {
...
#[no_mangle]
pub unsafe extern "C" fn tcp_stream_free(tcp_stream: HandleOwned<TcpStream>) {
...
/// `tcp_stream_res` must point at a valid `DebugResult<TcpStream>`. This function takes ownership of the `DebugResult`.
#[no_mangle]
pub unsafe extern "C" fn tcp_stream_result_debug_err(
    tcp_stream_res: HandleOwned<DebugResult<TcpStream>>,
) -> StringHandle {
...
#[no_mangle]
pub unsafe extern "C" fn string_free(s: StringHandle) {
...
/// `tcp_stream` must point at a valid `TcpStream`. This function takes ownership of the `TcpStream`.
#[no_mangle]
pub unsafe extern "C" fn tcp_stream_disconnect(
    tcp_stream: HandleOwned<TcpStream>,
) -> HandleOwned<DebugResult<()>> {
...
#[no_mangle]
pub unsafe extern "C" fn unit_result_free(unit_res: HandleOwned<DebugResult<()>>) {
...
#[no_mangle]
pub unsafe extern "C" fn unit_result_is_ok(unit_res: *const DebugResult<()>) -> FfiBool {
    (&*unit_res).is_ok().into()
}
...
/// `io_res` must point at a valid `DebugResult<()>`. This function takes ownership of the `DebugResult`.
#[no_mangle]
pub unsafe extern "C" fn unit_result_debug_err(
    unit_res: HandleOwned<DebugResult<()>>,
) -> StringHandle {
...
#[no_mangle]
pub unsafe extern "C" fn save_from_save_data(start: *const u8) -> HandleOwned<DebugResult<Save>> {
...
#[no_mangle]
pub unsafe extern "C" fn save_result_free(save_res: HandleOwned<DebugResult<Save>>) {
...
#[no_mangle]
pub unsafe extern "C" fn save_result_is_ok(save_res: *const DebugResult<Save>) -> FfiBool {
    (&*save_res).is_ok().into()
}
...
/// `save_res` must point at a valid `DebugResult<Save>`. This function takes ownership of the `DebugResult`.
#[no_mangle]
pub unsafe extern "C" fn save_result_unwrap(
    save_res: HandleOwned<DebugResult<Save>>,
) -> HandleOwned<Save> {
    HandleOwned::new(save_res.into_box().debug_unwrap())
}

#[no_mangle]
pub extern "C" fn save_default() -> HandleOwned<Save> {
    HandleOwned::default()
}
...
#[no_mangle]
pub unsafe extern "C" fn save_free(save: HandleOwned<Save>) {
    let _ = save.into_box();
}
...
#[no_mangle]
pub unsafe extern "C" fn save_debug(save: *const Save) -> StringHandle {
...
/// `save_res` must point at a valid `DebugResult<Save>`. This function takes ownership of the `DebugResult`.
#[no_mangle]
pub unsafe extern "C" fn save_result_debug_err(
    save_res: HandleOwned<DebugResult<Save>>,
) -> StringHandle {
...
#[no_mangle]
pub unsafe extern "C" fn save_send(
...
#[no_mangle]
pub unsafe extern "C" fn saves_diff(
    old_save: *const Save,
    new_save: *const Save,
) -> HandleOwned<save::Delta> {
...
#[no_mangle]
pub unsafe extern "C" fn saves_diff_free(diff: HandleOwned<save::Delta>) {
    let _ = diff.into_box();
}
...
/// `diff` must point at a valid `Delta`. This function takes ownership of the `Delta`.
#[no_mangle]
pub unsafe extern "C" fn saves_diff_send(
    tcp_stream: *mut TcpStream,
    diff: HandleOwned<save::Delta>,
) -> HandleOwned<DebugResult<()>> {
    HandleOwned::new(
        Packet::SaveDelta(*diff.into_box())
            .write_sync(&mut *tcp_stream)
            .map_err(DebugError::from),
    )
}
...
#[no_mangle]
pub extern "C" fn knowledge_none() -> HandleOwned<Knowledge> {
    HandleOwned::default()
}

#[no_mangle]
pub extern "C" fn knowledge_vanilla() -> HandleOwned<Knowledge> {
...
#[no_mangle]
pub unsafe extern "C" fn knowledge_free(knowledge: HandleOwned<Knowledge>) {
...
#[no_mangle]
pub unsafe extern "C" fn knowledge_send(
    tcp_stream: *mut TcpStream,
    knowledge: *const Knowledge,
) -> HandleOwned<DebugResult<()>> {
    HandleOwned::new(
        Packet::KnowledgeInit((&*knowledge).clone())
            .write_sync(&mut *tcp_stream)
            .map_err(DebugError::from),
    )
}
...
#[no_mangle]
pub unsafe extern "C" fn model_new(
    save: HandleOwned<Save>,
    knowledge: HandleOwned<Knowledge>,
) -> HandleOwned<ModelState> {
...
#[no_mangle]
pub unsafe extern "C" fn model_free(model: HandleOwned<ModelState>) {
...
#[no_mangle]
pub unsafe extern "C" fn ram_from_ranges(
    ranges: *const *const u8,
) -> HandleOwned<DebugResult<Ram>> {
    assert!(!ranges.is_null());
    let ranges = slice::from_raw_parts(ranges, ram::NUM_RANGES);
    let ranges = ranges
        .iter()
        .zip(ram::RANGES.iter().tuples())
        .map(|(&range, (_, &len))| slice::from_raw_parts(range, len as usize));
...
#[no_mangle]
pub unsafe extern "C" fn ram_result_free(ram_res: HandleOwned<DebugResult<Ram>>) {
...
#[no_mangle]
pub unsafe extern "C" fn ram_result_is_ok(ram_res: *const DebugResult<Ram>) -> FfiBool {
    (&*ram_res).is_ok().into()
}
...
/// `ram_res` must point at a valid `DebugResult<Ram>`. This function takes ownership of the `DebugResult`.
#[no_mangle]
pub unsafe extern "C" fn ram_result_unwrap(
    ram_res: HandleOwned<DebugResult<Ram>>,
) -> HandleOwned<Ram> {
...
/// `ram_res` must point at a valid `DebugResult<Ram>`. This function takes ownership of the `DebugResult`.
#[no_mangle]
pub unsafe extern "C" fn ram_result_debug_err(
    ram_res: HandleOwned<DebugResult<Ram>>,
) -> StringHandle {
...
#[no_mangle]
pub unsafe extern "C" fn ram_free(ram: HandleOwned<Ram>) {
    let _ = ram.into_box();
}
...
#[no_mangle]
pub unsafe extern "C" fn model_set_ram(model: *mut ModelState, ram: *const Ram) {
    let model = &mut *model;
    let ram = &*ram;
...
#[no_mangle]
pub unsafe extern "C" fn model_set_tracker_ctx(
    ...
    let data = slice::from_raw_parts(
        data,
        length.try_into().expect("negative or excessive length"),
    );
