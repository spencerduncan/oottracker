...
#[must_use]
pub fn mm_chest_mappings() -> Vec<FlagMapping> {
...
/// will be populated in a future issue.
#[must_use]
pub fn mm_collectible_mappings() -> Vec<FlagMapping> {
...
/// will be populated in a future issue.
#[must_use]
pub fn mm_special_mappings() -> Vec<FlagMapping> {
...
#[must_use]
pub fn mm_all_mappings() -> Vec<FlagMapping> {
